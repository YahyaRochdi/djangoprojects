...
attractions = [
  ...
  { 'attraction_name' : 'Sedona', 'state' : 'Arizona'},
  { 'attraction_name' : 'Monument Valley', 'state' : 'Arizona'},
  
  { 'attraction_name' : 'Mall of America', 'state' : 'Minnesota'},
  { 'attraction_name' : 'Scenic Drive', 'state' : 'Minnesota'},
  { 'attraction_name' : 'Mount Rushmore', 'state' : 'South Dakota'},
   { 'attraction_name' : 'Bad Land park', 'state' : 'South Dakota'},
      { 'attraction_name' : 'Wind Cave', 'state' : 'South Dakota'},
  { 'attraction_name' : 'Times Square', 'state' : 'New York'},
  { 'attraction_name' : 'Walt Disney World', 'state' : 'Florida'},
  { 'attraction_name' : 'Universal Orlando Resort', 'state' : 'Florida'},
  { 'attraction_name' : 'Epcot', 'state' : 'Florida'},
  { 'attraction_name' : 'Oculus Center', 'state' : 'New York'}
